...
const variants = {
	default: 'w-full h-[40px] flex items-center justify-center p-2 border border-transparent font-medium text-regular bg-blue-700 rounded focus:opacity-80 hover:opacity-80 transition-opacity',
